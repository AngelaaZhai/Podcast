...
knitr::include_graphics("podcasts header.jpg")
```
...
From the log mantissa of the data, we can tell that the data does not follow Benford’s Law. Because the data which follows Benfords's Law should has Mean closes to 0.5, Variance closes to 0.083, Ex. Kurtosis closes to -1.2, and Skewness closes to 0.
